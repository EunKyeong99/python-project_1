...
class Character:
    ...
    def __str__(self):
        return (f"{self.name} - HP: {self.hp}, 공격력 : {self.attack}, 방어력 : {self.defense}, 속도:{self.speed}")
...
class Equipment:
    ...
    def __str__(self):
        return (f"장비: {self.name}, 등급:{self.grade}, 공격력 : {self.attack_bonus}, 방어력 : {self.defense_bonus}")
...
class Hero(Character):
    ...
    def __str__(self):
        return (f"{self.name}[{self.role}] - HP: {self.hp}, 공격력 : {self.attack}, 방어력 : {self.defense}, 경험치:{self.exp}")
